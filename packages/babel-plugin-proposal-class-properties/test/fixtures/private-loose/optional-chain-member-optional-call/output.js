...
class Foo {
  ...
  static test() {
    ...
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr = babelHelpers.classPrivateFieldLooseBase(o.Foo, _self)[_self], _m)[_m])?.call(_babelHelpers$classPr);
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr2 = babelHelpers.classPrivateFieldLooseBase(o.Foo, _self)[_self].self, _m)[_m])?.call(_babelHelpers$classPr2);
    ...
    (o === null || o === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr3 = babelHelpers.classPrivateFieldLooseBase(o.Foo, _self)[_self].getSelf(), _m)[_m])?.call(_babelHelpers$classPr3);
    (_ref3 = o === null || o === void 0 ? void 0 : (_babelHelpers$classPr4 = babelHelpers.classPrivateFieldLooseBase(o.Foo, _self)[_self]).getSelf) === null || _ref3 === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_ref3.call(_babelHelpers$classPr4), _m)[_m]?.();
    ...
    (_call = (o === null || o === void 0 ? void 0 : (_babelHelpers$classPr5 = babelHelpers.classPrivateFieldLooseBase(o.Foo, _self)[_self]).getSelf)?.call(_babelHelpers$classPr5)) === null || _call === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_call.self, _m)[_m]?.();
    ...
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr6 = babelHelpers.classPrivateFieldLooseBase(fn().Foo, _self)[_self], _m)[_m])?.call(_babelHelpers$classPr6);
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr7 = babelHelpers.classPrivateFieldLooseBase(fn().Foo, _self)[_self].self, _m)[_m])?.call(_babelHelpers$classPr7);
    ...
    (fn === null || fn === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_babelHelpers$classPr8 = babelHelpers.classPrivateFieldLooseBase(fn().Foo, _self)[_self].getSelf(), _m)[_m])?.call(_babelHelpers$classPr8);
    (_ref9 = fn === null || fn === void 0 ? void 0 : (_babelHelpers$classPr9 = babelHelpers.classPrivateFieldLooseBase(fn().Foo, _self)[_self]).getSelf) === null || _ref9 === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_ref9.call(_babelHelpers$classPr9), _m)[_m]?.();
    ...
    (_call2 = (fn === null || fn === void 0 ? void 0 : (_babelHelpers$classPr10 = babelHelpers.classPrivateFieldLooseBase(fn().Foo, _self)[_self]).getSelf)?.call(_babelHelpers$classPr10)) === null || _call2 === void 0 ? void 0 : babelHelpers.classPrivateFieldLooseBase(_call2.self, _m)[_m]?.();
