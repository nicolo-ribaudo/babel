  ...
  }
  {
    ...
    new class extends B {
      constructor() {
        ...
        _A4 = A;
        [_initProto4] = babelHelpers.applyDecs2301(_A4, [[dec, 2, "method"], [noop(log.push(super(7).method())), 2, "noop"]], []).e;
        new A();
      }
    }();
    ...
    class A extends B {
      constructor() {
        ...
        new (_Dummy2 = class Dummy extends B {
          ...
          noop() {}
        }, [_initProto7] = babelHelpers.applyDecs2301(_Dummy2, [[noop(log.push(_initProto6(super(11)).method())), 2, "noop"]], []).e, _Dummy2)();
      }
      method() {
        return this.a;
      }
