...
}
{
  ...
  }
  {
    ...
    class A extends B {
      static {
        [_initProto2] = babelHelpers.applyDecs2301(this, [[dec, 2, "method"]], []).e;
      }
      constructor() {
  ...
  }
  {
    ...
    new class extends B {
      constructor() {
        ...
        class A extends B {
          static {
            [_initProto4] = babelHelpers.applyDecs2301(this, [[dec, 2, "method"], [noop(log.push(super(7).method())), 2, "noop"]], []).e;
          }
          constructor() {
  ...
  }
  {
    ...
    class A extends B {
      static {
        [_initProto5] = babelHelpers.applyDecs2301(this, [[dec, 2, "method"]], []).e;
      }
      constructor() {
        let key;
        new class Dummy extends B {
  ...
  }
  {
    ...
    class A extends B {
      ...
      constructor() {
        ...
        new class Dummy extends B {
          static {
            [_initProto7] = babelHelpers.applyDecs2301(this, [[noop(log.push(_initProto6(super(11)).method())), 2, "noop"]], []).e;
          }
          constructor() {
