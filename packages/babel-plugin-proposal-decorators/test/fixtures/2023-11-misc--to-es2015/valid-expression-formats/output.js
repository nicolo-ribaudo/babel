...
class Foo {
  ...
  method() {}
  makeClass() {
    var _init_bar, _init_extra_bar, _Nested;
    return _Nested = class Nested {
      constructor() {
        babelHelpers.defineProperty(this, "bar", _init_bar(this));
        _init_extra_bar(this);
      }
    }, [_init_bar, _init_extra_bar] = babelHelpers.applyDecs2311(_Nested, [], [[babelHelpers.classPrivateFieldGet2(_Nested, _a), 0, "bar"]]).e, _Nested;
  }
}
_Foo2 = Foo;
({
