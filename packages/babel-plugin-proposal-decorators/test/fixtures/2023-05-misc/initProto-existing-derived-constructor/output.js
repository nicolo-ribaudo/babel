{
  ...
  class A extends B {
    static {
      [_initProto] = babelHelpers.applyDecs2305(this, [[deco, 2, "method"]], [], 0, void 0, B).e;
    }
    constructor() {
      let a = 2;
...
}
{
  ...
  }
  {
    ...
    class A extends B {
      static {
        [_initProto2] = babelHelpers.applyDecs2305(this, [[dec, 2, "method"]], [], 0, void 0, B).e;
      }
      constructor() {
  ...
  }
  {
    ...
    new class extends B {
      constructor() {
        ...
        class A extends B {
          static {
            [_initProto4] = babelHelpers.applyDecs2305(this, [[dec, 2, "method"], [noop(log.push(super(7).method())), 2, "noop"]], [], 0, void 0, B).e;
          }
          constructor() {
  ...
  }
  {
    ...
    class A extends B {
      static {
        [_initProto5] = babelHelpers.applyDecs2305(this, [[dec, 2, "method"]], [], 0, void 0, B).e;
      }
      constructor() {
        let key;
        new class Dummy extends B {
  ...
  }
  {
    ...
    class A extends B {
      ...
      constructor() {
        ...
        new class Dummy extends B {
          static {
            [_initProto7] = babelHelpers.applyDecs2305(this, [[noop(log.push(_initProto6(super(11)).method())), 2, "noop"]], [], 0, void 0, B).e;
          }
          constructor() {
