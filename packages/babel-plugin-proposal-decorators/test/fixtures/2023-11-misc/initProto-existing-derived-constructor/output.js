  ...
  }
  {
    ...
    new class extends B {
      constructor() {
        ...
        class A extends B {
          static {
            [_initProto4] = babelHelpers.applyDecs2311(this, [], [[dec, 2, "method"], [noop(log.push(super(7).method())), 2, "noop"]], 0, void 0, B).e;
          }
          constructor() {
  ...
  }
  {
    ...
    class A extends B {
      ...
      constructor() {
        ...
        new class Dummy extends B {
          static {
            [_initProto7] = babelHelpers.applyDecs2311(this, [], [[noop(log.push(_initProto6(super(11)).method())), 2, "noop"]], 0, void 0, B).e;
          }
          constructor() {
