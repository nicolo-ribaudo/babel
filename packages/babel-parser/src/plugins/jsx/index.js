...
import PlaceholdersParser from "../placeholders";
...
export default class JSXParser extends PlaceholdersParser {
      ...
      switch (ch) {
        ...
        case charCodes.leftCurlyBrace:
          if (this.state.pos === this.state.start) {
            ...
            return this.getTokenFromCode(ch, true);
          }
  ...
  jsxGetTokenFromCode(code: number): boolean {
    if (this.state.inPropertyName) return false;
